...
public class AlarmBrodcast extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (!isScreenOn) {
            PowerManager.WakeLock wl = pm.newWakeLock(WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON
        ...
        final long[] DEFAULT_VIBRATE_PATTERN = {500, 500, 500, 500};
        ...
        //mBuilder.build().flags = Notification.FLAG_NO_CLEAR | Notification.PRIORITY_MAX | Notification.FLAG_SHOW_LIGHTS;
